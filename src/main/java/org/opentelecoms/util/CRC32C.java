 ...
 * 
 * Some portions of this file Copyright (c) 2012 Ready Technology (UK) Limited
 * and licensed under the GPL v3
 * 
 * This file was obtained from the Hadoop project and adapted for use
 * within Opentelecoms.org (addition of a test case and a method for
 * obtain the checksum as a byte array)
 * 
 */



package org.opentelecoms.util;
...
public class CRC32C implements Checksum {
	  ...
	  public byte[] getValueAsBytes() {
		  BigInteger l = BigInteger.valueOf(getValue());
		  byte[] _l = l.toByteArray();
		  byte[] _r = { 0, 0, 0, 0 };
		  int offset = 0;
		  if(_l.length > 4)
			  offset = _l.length - 4;
		  for(int i = 0; i < _l.length && i < 4; i++)
			  _r[3-i] = _l[offset + i];
		  return _r;
	  }
	...
	public static void main(String[] args) {
		...
		delegate.update(testV1, 0, testV1.length);
		System.out.println("Expcted: " + byteToHexString(testV1result, 0, 4));
		System.out.println(Integer.toHexString((int)delegate.getValue()));
		byte[] val = delegate.getValueAsBytes();
		System.out.println("byteToHexString: "
				+ byteToHexString(val, 0, 4));
	}
	...
	static byte[] testV1 = { 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58,
			0x59, 0x5a, 0x5b, 0x5c, 0x5d, 0x5e, 0x5f, 0x60, 0x61, 0x62, 0x63,
			0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b, 0x6c, 0x6d, 0x6e,
			0x6f, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78 };

	static byte[] testV1result = { (byte) 0xed, (byte) 0xbd, 0x74, (byte) 0xde };
}
